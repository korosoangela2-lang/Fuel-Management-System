...
class TestCustomerIsolation:
    ...
    def test_super_admin_can_create_customer_for_any_region(self, client, auth_header,
                                                             super_admin, mombasa_region):
        res = client.post(
            "/api/customers",
            json={
                "name": "Mombasa Holdings",
                "phone": "0700000002",
                "region_id": mombasa_region.id,
            },
    ...
    def test_super_admin_requires_region_id_on_create(self, client, auth_header,
                                                       super_admin):
        res = client.post(
            "/api/customers",
            json={
                "name": "Regionless Corp",
                "phone": "0700000003",
            },
            headers=auth_header(super_admin),
        )
