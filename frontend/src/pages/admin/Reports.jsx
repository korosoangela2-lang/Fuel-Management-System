    ...
    <AdminLayout>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-slate-400 mt-1">Sales, deliveries and top customers for your region.</p>
        </div>

        <form onSubmit={handleFilter} className="bg-slate-900 rounded-xl shadow p-4 flex flex-wrap gap-4 items-end">
          <div>
          ...
          <button className="bg-amber-600 text-white px-5 py-2 rounded-lg hover:bg-amber-700">
            Apply
          </button>
        </form>
          ...
          <>
            ...
            <div className="bg-slate-900 rounded-xl shadow p-6">
              ...
              {topCustomers.length === 0 ? (
                <p className="text-slate-400 text-sm">No customer revenue recorded yet.</p>
              ) : (
                <table className="min-w-full">
                  ...
                  <tbody>
                    {topCustomers.map((customer) => (
                      <tr key={customer.customer_id} className="border-t border-slate-800">
