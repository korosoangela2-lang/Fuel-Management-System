      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-slate-500 mt-1">Manage customer accounts in your region.</p>
          </div>
                  ...
                  filteredCustomers.map((customer) => (
                    <tr key={customer.id} className="border-t">
                      ...
                      <td className="px-6 py-4">
                        <span className={`px-3 py-1 rounded-full text-sm font-medium ${customer.is_active ? "bg-green-100 text-green-700" : "bg-slate-200 text-slate-600"}`}>
